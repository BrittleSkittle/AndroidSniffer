...
public abstract class AnnotatedFieldMethod
	...
	private static class BooleanFunction
		 ...
		 * @see AnnotatedFieldMethod#booleanMethod(org.jnetpcap.packet.JHeader,
		 *      String)
		 */
		@Override
		 ...
		 * @param field
		 *          the field
		 * @see AnnotatedFieldMethod#configFromField(AnnotatedField)
		 */
	...
	private static class IntFunction
		 ...
		 *          the name
		 * @return the int
		 * @see AnnotatedFieldMethod#intMethod(org.jnetpcap.packet.JHeader,
		 *      String)
		 */
		@Override
	...
	private static class LongFunction
		 ...
		 *          the name
		 * @return the long
		 * @see AnnotatedFieldMethod#longMethod(org.jnetpcap.packet.JHeader,
		 *      String)
		 */
		@Override
	...
	private static class ObjectFunction
		 ...
		 *          the name
		 * @return the object
		 * @see AnnotatedFieldMethod#objectMethod(org.jnetpcap.packet.JHeader,
		 *      String)
		 */
		@Override
	...
	private static class StringFunction
		 ...
		 *          the name
		 * @return the string
		 * @see AnnotatedFieldMethod#stringMethod(org.jnetpcap.packet.JHeader,
		 *      String)
		 */
		@Override
	 ...
	 * @param method
	 *          the method
	 * @see AnnotatedMethod#validateSignature(Method)
	 */
	@Override
