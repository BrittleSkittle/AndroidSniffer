...
public class AnnotatedHeaderLengthMethod
	...
	public static AnnotatedHeaderLengthMethod[] inspectClass(
		...
		if (methods[Type.HEADER.ordinal()] == null) {
	 ...
	 *          the type
	 */
	private AnnotatedHeaderLengthMethod(Method method, Type type) {
		super(method);
		this.type = type;
	 ...
	 * 
	 * @return the string
	 * @see AnnotatedMethod#toString()
	 */
	public String toString() {
		if (method == null) {
			String property =
			    (type == Type.HEADER) ? "length" : type.toString()
			        .toLowerCase();
