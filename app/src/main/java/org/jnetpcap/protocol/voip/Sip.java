...
public class Sip
	 ...
	 * @param line
	 *          the line
	 * @see AbstractMessageHeader#decodeFirstLine(String)
	 */
	@Override
	 ...
	 */
	public String fieldValue(final Fields field) {
	 ...
	 * @return the value of the field or null if not present
	 */
	public String fieldValue(final Request field) {
		return super.fieldValue(String.class, field);
	}
	 ...
	 * @return the value of the field or null if not present
	 */
	public String fieldValue(final Response field) {
		return super.fieldValue(String.class, field);
	}
